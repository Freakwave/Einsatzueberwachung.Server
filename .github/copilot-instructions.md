...
* [2026-04-28] - Projektstruktur: `Einsatzueberwachung.Mobile` (PWA) existiert nicht mehr. Mobile Ansichten sind direkt im Server-Projekt integriert. Stattdessen gibt es `Einsatzueberwachung.LiveTracking` (WPF, Windows-only) für USB-GPS-Geräte.
...
* [2026-04-28] - Keine separate `AI_AGENT_GUIDELINES.md` anlegen — alles gehört direkt in `.github/copilot-instructions.md`. Diese Datei ist die einzige Wahrheitsquelle.
